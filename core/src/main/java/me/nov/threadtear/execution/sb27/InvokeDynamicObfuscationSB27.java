...
/*
    ...
    TODO: Checks
 */
public class InvokeDynamicObfuscationSB27 extends Execution {
    public InvokeDynamicObfuscationSB27() {
        super(ExecutionCategory.SB27, "Invoke Dynamic Obfuscation Removal", "Fixes InvokeDynamic Calls.<br>Taken from <a href=\"https://github.com/narumii/Deobfuscator/\">Narumi Deobf</a>", ExecutionTag.POSSIBLE_DAMAGE);
    }
        ...
        classNode.methods.stream()
                ...
                .forEach(methodNode -> {
                    ...
                    Arrays.stream(methodNode.instructions.toArray())
                            ...
                            .filter(node -> ASMHelper.isType(node.getNext().getNext()) || ASMHelper.isString(node.getNext().getNext()))
                            ...
                            .forEach(node -> {
                                ...
                                if (ASMHelper.isType(ldc))
                                    types.put(position, ASMHelper.getType(ldc));
                                else
                                    callInfos.put(position, ASMHelper.getString(ldc));
